<nav class="admin-nav">
    ...
    <div class="admin-nav-group">
        ...
        <div class="admin-submenu" style="{{ (Request::is('vendor/customers*') || Request::is('vendor/invitations*')) ? 'display: flex;' : 'display: none;' }} padding-left: 20px; margin-top: 4px; flex-direction: column; gap: 4px;">
            <a href="{{ route('vendor.customers.index') }}" class="submenu-item {{ Request::is('vendor/customers*') ? 'active' : '' }}" style="{{ Request::is('vendor/customers*') ? 'color: var(--brand, #52ead2) !important; font-weight: bold; background: rgba(255, 255, 255, 0.04) !important;' : '' }}">
                <span class="dot" style="{{ Request::is('vendor/customers*') ? 'background: var(--brand, #52ead2) !important;' : '' }}"></span>
                Customer List
            </a>
            <a href="{{ route('vendor.invitations.index') }}" class="submenu-item {{ Request::is('vendor/invitations*') ? 'active' : '' }}" style="{{ Request::is('vendor/invitations*') ? 'color: var(--brand, #52ead2) !important; font-weight: bold; background: rgba(255, 255, 255, 0.04) !important;' : '' }}">
                <span class="dot" style="{{ Request::is('vendor/invitations*') ? 'background: var(--brand, #52ead2) !important;' : '' }}"></span>
                User Invitations
            </a>
        </div>
    </div>
