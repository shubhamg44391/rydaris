...
@section('main-content')
    <div class="admin-panel">
        <div class="panel-head" style="display:flex;justify-content:space-between;align-items:center;">
            <div>
                <h2 style="font-size:1.4rem;color:#111827;margin:0;">Add Location</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mb-4" id="field-embed" style="display:none;">
                        ...
                        <textarea class="form-control @error('map_embed') is-invalid @enderror"
                                  ...
                                  style="border:1px solid #d7e0e8;border-radius:var(--radius);padding:12px;font-size:0.95rem;resize:vertical;">{{ old('map_embed') }}</textarea>
