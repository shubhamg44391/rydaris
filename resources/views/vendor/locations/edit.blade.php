...
@section('main-content')
    <div class="admin-panel">
        ...
        <div class="panel-body">
            <form method="POST" action="{{ route('vendor.locations.update', $location->id) }}" id="locationForm" onsubmit="event.preventDefault(); submitLocationForm(event); return false;">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mb-4" id="field-embed" style="display:none;">
                        ...
                        <textarea class="form-control form-input-custom @error('map_embed') is-invalid @enderror"
                                  ...
                                  style="padding:12px;font-size:0.95rem;resize:vertical;">{{ old('map_embed', $location->map_embed) }}</textarea>
...
function submitLocationForm(e) {
    ...
    var $btn = $('#locationForm').find('button[type="submit"]');
    ...
    $.ajax({
        ...
        error: function(xhr) {
            var errorMsg = 'An error occurred while updating location.';
