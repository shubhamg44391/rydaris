...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row mb-5">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 vendor-pricing-card">
                <div class="card-body d-flex flex-column" style="padding: 30px;">
                    @if($pkg->eyebrow)
                        <div class="text-uppercase mb-2 small fw-semibold pricing-eyebrow">{{ $pkg->eyebrow }}</div>
                    @endif
                    
                    <h3 class="card-title mb-3 pricing-title">{{ $pkg->name }}</h3>
                    <p class="card-text pricing-desc" style="min-height: 48px; font-size: 0.95rem;">{{ $pkg->description }}</p>
                    
                    <div class="my-4">
                        <span id="pkg-price-{{ $pkg->id }}" data-raw-price="{{ $pkg->price }}" class="display-5 fw-bold pricing-amount" style="font-size: 2.5rem;">{{ $pkg->price }}</span>
                        @if(strtolower($pkg->price) !== 'custom')
                            <span class="pricing-period">/{{ $pkg->billing_period }}</span>
                        @endif
                    </div>
                    
                    <ul class="list-unstyled mb-4 pricing-features">
                      {{-- Bookings --}}
                      @if($pkg->booking_menu && ($pkg->no_of_bookings === null || (int)$pkg->no_of_bookings > 0))
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-check me-2 feature-icon-on"></i>
                            <span class="feature-text-on">{{ $pkg->no_of_bookings !== null ? ($pkg->no_of_bookings . ' Bookings Included') : 'Unlimited Bookings' }}</span>
                        </li>
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">Bookings Not Included</span>
                        </li>
                      @endif
                      ...
                      @if($pkg->vehicles_menu && ($pkg->no_of_vehicles === null || (int)$pkg->no_of_vehicles > 0))
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-check me-2 feature-icon-on"></i>
                            <span class="feature-text-on">{{ $pkg->no_of_vehicles !== null ? ($pkg->no_of_vehicles . ' Vehicles Included') : 'Unlimited Vehicles' }}</span>
                        </li>
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">Vehicles Not Included</span>
                        </li>
                      @endif
                      ...
                      @if($pkg->vehicles_menu && ($pkg->no_of_groups === null || (int)$pkg->no_of_groups > 0))
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-check me-2 feature-icon-on"></i>
                            <span class="feature-text-on">{{ $pkg->no_of_groups !== null ? ($pkg->no_of_groups . ' Groups Included') : 'Unlimited Groups' }}</span>
                        </li>
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">Groups Not Included</span>
                        </li>
                      @endif
                      ...
                      @if($pkg->locations_menu && ($pkg->no_of_locations === null || (int)$pkg->no_of_locations > 0))
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-check me-2 feature-icon-on"></i>
                            <span class="feature-text-on">{{ $pkg->no_of_locations !== null ? ($pkg->no_of_locations . ' Locations Included') : 'Unlimited Locations' }}</span>
                        </li>
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">Locations Not Included</span>
                        </li>
                      @endif
                      ...
                      @if($pkg->customers_menu && ($pkg->no_of_users === null || (int)$pkg->no_of_users > 0))
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-check me-2 feature-icon-on"></i>
                            <span class="feature-text-on">{{ $pkg->no_of_users !== null ? ($pkg->no_of_users . ' Customers Included') : 'Unlimited Customers' }}</span>
                        </li>
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">Customers Not Included</span>
                        </li>
                      @endif
                      ...
                      @if($pkg->customers_menu && ($pkg->no_of_invitations === null || (int)$pkg->no_of_invitations > 0))
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-check me-2 feature-icon-on"></i>
                            <span class="feature-text-on">{{ $pkg->no_of_invitations !== null ? ($pkg->no_of_invitations . ' Invitations Included') : 'Unlimited Invitations' }}</span>
                        </li>
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">Invitations Not Included</span>
                        </li>
                      @endif
                      ...
                      @if($pkg->fleet_management_menu)
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-check me-2 feature-icon-on"></i>
                            <span class="feature-text-on">Fleet Management Included</span>
                        </li>
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">Fleet Management Not Included</span>
                        </li>
                      @endif
                      ...
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">Maintenance Schedules Not Included</span>
                        </li>
                      @endif
                      ...
                      @if($pkg->extras_menu && ($pkg->no_of_extras === null || (int)$pkg->no_of_extras > 0))
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-check me-2 feature-icon-on"></i>
                            <span class="feature-text-on">{{ $pkg->no_of_extras !== null ? ($pkg->no_of_extras . ' Extras Included') : 'Unlimited Extras' }}</span>
                        </li>
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">Extras Not Included</span>
                        </li>
                      @endif
                      ...
                      @if($pkg->extras_menu && ($pkg->no_of_insurances === null || (int)$pkg->no_of_insurances > 0))
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-check me-2 feature-icon-on"></i>
                            <span class="feature-text-on">{{ $pkg->no_of_insurances !== null ? ($pkg->no_of_insurances . ' Insurances Included') : 'Unlimited Insurances' }}</span>
                        </li>
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">Insurances Not Included</span>
                        </li>
                      @endif
                      ...
                      @if($pkg->extras_menu && ($pkg->no_of_features === null || (int)$pkg->no_of_features > 0))
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-check me-2 feature-icon-on"></i>
                            <span class="feature-text-on">{{ $pkg->no_of_features !== null ? ($pkg->no_of_features . ' Features Included') : 'Unlimited Features' }}</span>
                        </li>
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">Features Not Included</span>
                        </li>
                      @endif
                      ...
                      @if($pkg->extras_menu && ($pkg->no_of_rules === null || (int)$pkg->no_of_rules > 0))
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-check me-2 feature-icon-on"></i>
                            <span class="feature-text-on">{{ $pkg->no_of_rules !== null ? ($pkg->no_of_rules . ' Rules Included') : 'Unlimited Rules' }}</span>
                        </li>
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">Rules Not Included</span>
                        </li>
                      @endif
                      ...
                      @if($pkg->coupons_menu && ($pkg->no_of_coupons === null || (int)$pkg->no_of_coupons > 0))
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-check me-2 feature-icon-on"></i>
                            <span class="feature-text-on">{{ $pkg->no_of_coupons !== null ? ($pkg->no_of_coupons . ' Coupons Included') : 'Unlimited Coupons' }}</span>
                        </li>
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">Coupons Not Included</span>
                        </li>
                      @endif
                      ...
                      @if($pkg->support_ticket_menu && ($pkg->no_of_support_tickets === null || (int)$pkg->no_of_support_tickets > 0))
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-check me-2 feature-icon-on"></i>
                            <span class="feature-text-on">{{ $pkg->no_of_support_tickets !== null ? ($pkg->no_of_support_tickets . ' Support Tickets Included') : 'Unlimited Support Tickets' }}</span>
                        </li>
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">Support Tickets Not Included</span>
                        </li>
                      @endif
                      ...
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">System Settings Not Included</span>
                        </li>
                      @endif
                      ...
                      @else
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bx bx-x-circle me-2" style="color: #ef4444; font-size: 1.1rem;"></i>
                            <span style="color: #cbd5e1;">Community Access Not Included</span>
                        </li>
                      @endif

                      {{-- Custom Features --}}
                      @if(!empty($pkg->features) && is_array($pkg->features))
                        @foreach($pkg->features as $customFeature)
                          @if(!empty(trim($customFeature)))
                            <li class="mb-2 d-flex align-items-center">
                                <i class="bx bx-check me-2 feature-icon-on"></i>
                                <span class="feature-text-on">{{ trim($customFeature) }}</span>
                            </li>
                          @endif
                        @endforeach
                      @endif
                    ...
                    <div class="mt-auto pt-3">
                        @if(strtolower($pkg->price) === 'custom')
                            <button type="button" onclick="document.getElementById('customPackageModal').style.display='flex'" class="btn w-100 pricing-btn-primary">
                        ...
                        @else
                            ...
                            @endphp
                            @if($isActive)
                                <button type="button" class="btn w-100 current-pkg-btn" disabled style="background: linear-gradient(135deg, #10b981 0%, #059669 100%) !important; color: #ffffff !important; border: none !important; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4) !important; opacity: 1 !important; font-weight: 800 !important; padding: 12px 20px !important; border-radius: 999px !important;">
                                    Active Plan <i class="bx bx-check-circle ms-1" style="font-size: 1.1rem; vertical-align: middle;"></i>
                                </button>
                            @else
                                <button type="button" onclick="openDetailsModal({{ $pkg->id }}, '{{ $pkg->name }}', '{{ $pkg->price }}', '{{ $pkg->billing_period }}')" class="btn w-100 pricing-btn-primary">
    ...
    <div id="confirmDetailsModal" style="display: none; position: fixed; z-index: 9999; left: 0; top: 0; width: 100%; height: 100%; overflow: auto; background-color: rgba(0,0,0,0.85); align-items: center; justify-content: center; backdrop-filter: blur(8px);">
        <div style="background: #111620; border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; width: 100%; max-width: 680px; max-height: 95vh; overflow-y: auto; padding: 28px; box-shadow: 0 20px 60px rgba(0,0,0,0.6); position: relative; font-family: 'Inter', sans-serif; color: #f8fafc; text-align: left; box-sizing: border-box;">
            ...
            <div style="background: rgba(255, 255, 255, 0.03); border: 1px dashed rgba(82, 234, 210, 0.25); border-radius: 12px; padding: 15px 20px; margin-bottom: 20px; font-size: 0.95rem; line-height: 1.6;">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 15px;">
                <div style="grid-column: span 1;">
                    ...
                    <input type="text" id="custName" value="{{ auth()->check() ? trim((auth()->user()->first_name ?? '') . ' ' . (auth()->user()->name ?? '')) : '' }}" readonly style="width: 100%; padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 8px; color: #ffffff; font-size: 0.95rem; outline: none;" />
                </div>
                ...
                <div style="grid-column: span 1;">
                    ...
                    <div style="display: flex; gap: 10px;">
                        <select id="custCountryCode" disabled style="padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 8px; color: #ffffff; font-size: 0.95rem; outline: none; width: 80px; cursor: not-allowed; text-align: center;">
                            <option value="{{ auth()->check() ? (auth()->user()->country_code ?? 'IN') : 'IN' }}">{{ auth()->check() ? (auth()->user()->country_code ?? 'IN') : 'IN' }}</option>
                        </select>
                        <input type="text" id="custPhone" value="{{ auth()->check() ? auth()->user()->contact_number : '' }}" readonly style="flex: 1; padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 8px; color: #ffffff; font-size: 0.95rem; outline: none;" />
                    </div>
                </div>
                ...
                <div style="grid-column: span 1;">
                    ...
                    <input type="email" id="custEmail" value="{{ auth()->check() ? auth()->user()->email : '' }}" readonly style="width: 100%; padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 8px; color: #ffffff; font-size: 0.95rem; outline: none;" />
                </div>
                ...
                <div style="grid-column: span 1;">
                    ...
                    <input type="email" id="custConfirmEmail" value="{{ auth()->check() ? auth()->user()->email : '' }}" readonly style="width: 100%; padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 8px; color: #ffffff; font-size: 0.95rem; outline: none;" />
                </div>
                ...
                <div style="grid-column: span 1; position: relative;">
                    ...
                    <input type="text" id="custStreetAddress" value="{{ auth()->check() ? (auth()->user()->street_address ?? auth()->user()->subscription?->street_address ?? '') : '' }}" required style="width: 100%; padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 8px; color: #ffffff; font-size: 0.95rem; outline: none;" placeholder="Start typing your street address..." autocomplete="off" />
                ...
                <div style="grid-column: span 1;">
                    ...
                    <input type="text" id="custLandmark" value="{{ auth()->check() ? (auth()->user()->landmark ?? auth()->user()->subscription?->landmark ?? '') : '' }}" required style="width: 100%; padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 8px; color: #ffffff; font-size: 0.95rem; outline: none;" placeholder="Landmark (e.g. near metro station)" />
                </div>
                ...
                <div style="grid-column: span 2; display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 10px;">
                    <div>
                        ...
                        <input type="text" id="custPincode" value="{{ auth()->check() ? (auth()->user()->pincode ?? auth()->user()->subscription?->pincode ?? '') : '' }}" required style="width: 100%; padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 8px; color: #ffffff; font-size: 0.95rem; outline: none;" placeholder="Pincode" />
                    </div>
                    <div>
                        ...
                        <input type="text" id="custCity" value="{{ auth()->check() ? (auth()->user()->city ?? auth()->user()->subscription?->city ?? '') : '' }}" required style="width: 100%; padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 8px; color: #ffffff; font-size: 0.95rem; outline: none;" placeholder="City" />
                    </div>
                    <div>
                        ...
                        <input type="text" id="custCountry" value="{{ auth()->check() ? (auth()->user()->country ?? auth()->user()->subscription?->country ?? '') : '' }}" required style="width: 100%; padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 8px; color: #ffffff; font-size: 0.95rem; outline: none;" placeholder="Country" />
                    </div>
                </div>

                <div style="grid-column: span 2;">
                    <button onclick="proceedToPay()" id="proceedPayBtn" style="width: 100%; margin-top: 10px; padding: 14px; background: linear-gradient(135deg, #52ead2 0%, #80a7ff 100%); color: #051013; border: none; border-radius: 999px; font-weight: 800; font-size: 1rem; cursor: pointer; transition: all 0.25s ease; box-shadow: 0 4px 15px rgba(82, 234, 210, 0.35); display: flex; align-items: center; justify-content: center; gap: 8px;">
