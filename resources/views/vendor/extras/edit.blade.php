        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('vendor.extras.update', $item->id) }}">
                ...
                <div class="d-flex align-items-center gap-3" style="display: flex; gap: 16px; align-items: center; margin-top: 24px;">
                    <button type="submit" class="btn btn-primary rounded-pill px-4" style="min-height: 40px; font-weight: 800; font-size: 0.9rem; background: linear-gradient(135deg, #80a7ff 0%, #52ead2 100%); border: none; color: #051013; cursor: pointer;">{{ $type === 'extra' ? 'Update Extra' : 'Update Insurance' }}</button>
