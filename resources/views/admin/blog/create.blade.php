        ...
        <div class="panel-body">
            <form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group" style="margin-bottom: 15px;">
                    ...
                    <input type="text" name="title" required value="{{ old('title') }}" style="width: 100%; padding: 10px; border-radius: var(--radius); border: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.2); color: #fff;">
                ...
                <div class="form-group" style="margin-bottom: 15px;">
                    ...
                    <input type="text" name="slug" value="{{ old('slug') }}" placeholder="e.g. my-awesome-post" style="width: 100%; padding: 10px; border-radius: var(--radius); border: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.2); color: #fff;">
                    <small style="color: #94a3b8; display: block; margin-top: 5px;">Leave empty to auto-generate from title.</small>
                ...
                <div class="form-group" style="margin-bottom: 15px;">
                    ...
                    <input type="text" name="meta_title" value="{{ old('meta_title') }}" style="width: 100%; padding: 10px; border-radius: var(--radius); border: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.2); color: #fff;">
                </div>

                <div class="form-group" style="margin-bottom: 15px;">
                    <label style="display: block; margin-bottom: 5px; font-weight: bold; color: var(--text-color);">Meta Description (SEO)</label>
                    <textarea name="meta_description" rows="2" style="width: 100%; padding: 10px; border-radius: var(--radius); border: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.2); color: #fff;">{{ old('meta_description') }}</textarea>
                </div>

                <div class="form-group" style="margin-bottom: 15px;">
                    <label style="display: block; margin-bottom: 5px; font-weight: bold; color: var(--text-color);">Meta Keywords (SEO)</label>
                    <input type="text" name="meta_keyword" value="{{ old('meta_keyword') }}" placeholder="e.g. car rental, blog, tips" style="width: 100%; padding: 10px; border-radius: var(--radius); border: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.2); color: #fff;">
                </div>

                <div class="form-group" style="margin-bottom: 15px;">
                    <label style="display: block; margin-bottom: 5px; font-weight: bold; color: var(--text-color);">Excerpt (Short Summary)</label>
                    <textarea name="excerpt" rows="3" style="width: 100%; padding: 10px; border-radius: var(--radius); border: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.2); color: #fff;">{{ old('excerpt') }}</textarea>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 15px;">
                    ...
                    <textarea name="content" required rows="10" style="width: 100%; padding: 10px; border-radius: var(--radius); border: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.2); color: #fff;">{{ old('content') }}</textarea>
                ...
                <div style="display: flex; gap: 10px;">
                    <button type="submit" style="background: var(--brand); color: #061218; font-weight: bold; border: none; border-radius: var(--radius); padding: 10px 20px; cursor: pointer;">Save Post</button>
