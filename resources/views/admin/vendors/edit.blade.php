...
@section('main-content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Admin / Vendors /</span> Edit Vendor</h4>

        <div class="row">
            <div class="col-md-8">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Edit Vendor Profile</h5>
                        ...
                        <form method="POST" action="{{ route('admin.vendors.update', $vendor->id) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('first_name') is-invalid @enderror" id="first_name" name="first_name"
                                    value="{{ old('first_name', $vendor->first_name) }}" required placeholder="Enter first name" />
                                @error('first_name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email"
                                    value="{{ old('email', $vendor->email) }}" required placeholder="name@company.com" />
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <select name="country_code" class="form-select @error('country_code') is-invalid @enderror" style="max-width: 130px;" required>
                                        ...
                                        <option value="+54" {{ old('country_code', $vendor->country_code) === '+54' ? 'selected' : '' }}>+54 (AR)</option>
                                    ...
                                    <input type="tel" id="contact_number" name="contact_number" class="form-control @error('contact_number') is-invalid @enderror"
                                        placeholder="Phone number" value="{{ old('contact_number', $vendor->contact_number) }}" required />
                                </div>
                                @error('country_code')
                            ...
                            <a href="{{ route('admin.vendors.index') }}" class="btn btn-outline-secondary mt-2 ms-2">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
