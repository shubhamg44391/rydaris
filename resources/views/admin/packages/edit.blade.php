                ...
                <div class="row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    ...
                    <div>
                        ...
                        <select id="billing_period" name="billing_period" class="form-select form-input-custom" style="border: 1px solid #d7e0e8; border-radius: var(--radius); padding: 12px; font-size: 0.95rem; width: 100%; cursor: pointer;">
                            <option value="/ month" {{ old('billing_period', $package->billing_period) === '/ month' ? 'selected' : '' }}>Monthly</option>
                            <option value="/ quarter" {{ old('billing_period', $package->billing_period) === '/ quarter' ? 'selected' : '' }}>Quarterly</option>
                            <option value="/ year" {{ old('billing_period', $package->billing_period) === '/ year' ? 'selected' : '' }}>Yearly</option>
                            <option value="" {{ !in_array(old('billing_period', $package->billing_period), ['/ month', '/ quarter', '/ year']) ? 'selected' : '' }}>Custom</option>
                        </select>
                    ...
                    <div>
                        ...
                        <div style="margin-top: 8px;">
                            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 0.88rem; color: var(--muted, #a8b3c5);">
                                <input type="checkbox" id="is_free_pkg" style="width: 16px; height: 16px; accent-color: var(--brand, #52ead2);" {{ strtolower(old('price', $package->price)) === 'free' ? 'checked' : '' }} />
                                Is Free Package
                            </label>
                        </div>
                        @error('price')
                ...
                <div class="mb-4 menu-permissions-wrapper" style="border: 1px solid var(--line, rgba(255, 255, 255, 0.12)); border-radius: var(--radius); padding: 24px; background: var(--bg-2, #0b1020);">
                    ...
                    <div class="permissions-grid">
                        ...
                        <div class="menu-permission-card">
                            <div style="display: flex; align-items: center; gap: 12px; min-width: 260px; flex-shrink: 0;">
                                <label class="theme-switch">
                                    <input type="checkbox" id="booking_menu" name="booking_menu" value="1" {{ old('booking_menu', $package->booking_menu) ? 'checked' : '' }} />
                            ...
                            <div id="booking_limit_container" class="limit-input-wrapper">
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div class="segmented-control">
                                        <input type="radio" name="limit_type_no_of_bookings" id="no_of_bookings_unlimited" value="unlimited" {{ (old('limit_type_no_of_bookings', $package->no_of_bookings !== null ? 'limited' : 'unlimited') === 'unlimited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_bookings', 'unlimited')" />
                                        <label for="no_of_bookings_unlimited">Unlimited</label>

                                        <input type="radio" name="limit_type_no_of_bookings" id="no_of_bookings_limited" value="limited" {{ (old('limit_type_no_of_bookings', $package->no_of_bookings !== null ? 'limited' : 'unlimited') === 'limited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_bookings', 'limited')" />
                        ...
                        <div class="menu-permission-card">
                            <div style="display: flex; align-items: center; gap: 12px; min-width: 260px; flex-shrink: 0;">
                                <label class="theme-switch">
                                    <input type="checkbox" id="vehicles_menu" name="vehicles_menu" value="1" {{ old('vehicles_menu', $package->vehicles_menu) ? 'checked' : '' }} />
                                    <span class="slider round"></span>
                                </label>
                            ...
                            <div id="vehicles_limit_container" class="limit-input-wrapper" style="flex-direction: column; gap: 12px; align-items: flex-end;">
                                ...
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div class="segmented-control">
                                        <input type="radio" name="limit_type_no_of_vehicles" id="no_of_vehicles_unlimited" value="unlimited" {{ (old('limit_type_no_of_vehicles', $package->no_of_vehicles !== null ? 'limited' : 'unlimited') === 'unlimited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_vehicles', 'unlimited')" />
                                        <label for="no_of_vehicles_unlimited">Unlimited</label>

                                        <input type="radio" name="limit_type_no_of_vehicles" id="no_of_vehicles_limited" value="limited" {{ (old('limit_type_no_of_vehicles', $package->no_of_vehicles !== null ? 'limited' : 'unlimited') === 'limited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_vehicles', 'limited')" />
                                ...
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div class="segmented-control">
                                        <input type="radio" name="limit_type_no_of_groups" id="no_of_groups_unlimited" value="unlimited" {{ (old('limit_type_no_of_groups', $package->no_of_groups !== null ? 'limited' : 'unlimited') === 'unlimited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_groups', 'unlimited')" />
                                        <label for="no_of_groups_unlimited">Unlimited</label>

                                        <input type="radio" name="limit_type_no_of_groups" id="no_of_groups_limited" value="limited" {{ (old('limit_type_no_of_groups', $package->no_of_groups !== null ? 'limited' : 'unlimited') === 'limited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_groups', 'limited')" />
                        ...
                        <div class="menu-permission-card">
                            <div style="display: flex; align-items: center; gap: 12px; min-width: 260px; flex-shrink: 0;">
                                <label class="theme-switch">
                                    <input type="checkbox" id="locations_menu" name="locations_menu" value="1" {{ old('locations_menu', $package->locations_menu) ? 'checked' : '' }} />
                                    <span class="slider round"></span>
                                </label>
                            ...
                            <div id="locations_limit_container" class="limit-input-wrapper" style="flex-direction: column; gap: 12px; align-items: flex-end;">
                                ...
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div class="segmented-control">
                                        <input type="radio" name="limit_type_no_of_locations" id="no_of_locations_unlimited" value="unlimited" {{ (old('limit_type_no_of_locations', $package->no_of_locations !== null ? 'limited' : 'unlimited') === 'unlimited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_locations', 'unlimited')" />
                                        <label for="no_of_locations_unlimited">Unlimited</label>

                                        <input type="radio" name="limit_type_no_of_locations" id="no_of_locations_limited" value="limited" {{ (old('limit_type_no_of_locations', $package->no_of_locations !== null ? 'limited' : 'unlimited') === 'limited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_locations', 'limited')" />
                                ...
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div class="segmented-control">
                                        <input type="radio" name="limit_type_no_of_branches" id="no_of_branches_unlimited" value="unlimited" {{ (old('limit_type_no_of_branches', $package->no_of_branches !== null ? 'limited' : 'unlimited') === 'unlimited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_branches', 'unlimited')" />
                                        <label for="no_of_branches_unlimited">Unlimited</label>

                                        <input type="radio" name="limit_type_no_of_branches" id="no_of_branches_limited" value="limited" {{ (old('limit_type_no_of_branches', $package->no_of_branches !== null ? 'limited' : 'unlimited') === 'limited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_branches', 'limited')" />
                        ...
                        <div class="menu-permission-card">
                            <div style="display: flex; align-items: center; gap: 12px; min-width: 260px; flex-shrink: 0;">
                                <label class="theme-switch">
                                    <input type="checkbox" id="customers_menu" name="customers_menu" value="1" {{ old('customers_menu', $package->customers_menu) ? 'checked' : '' }} />
                                    <span class="slider round"></span>
                                </label>
                            ...
                            <div id="customers_limit_container" class="limit-input-wrapper" style="flex-direction: column; gap: 12px; align-items: flex-end;">
                                ...
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div class="segmented-control">
                                        <input type="radio" name="limit_type_no_of_users" id="no_of_users_unlimited" value="unlimited" {{ (old('limit_type_no_of_users', $package->no_of_users !== null ? 'limited' : 'unlimited') === 'unlimited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_users', 'unlimited')" />
                                        <label for="no_of_users_unlimited">Unlimited</label>

                                        <input type="radio" name="limit_type_no_of_users" id="no_of_users_limited" value="limited" {{ (old('limit_type_no_of_users', $package->no_of_users !== null ? 'limited' : 'unlimited') === 'limited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_users', 'limited')" />
                                ...
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div class="segmented-control">
                                        <input type="radio" name="limit_type_no_of_invitations" id="no_of_invitations_unlimited" value="unlimited" {{ (old('limit_type_no_of_invitations', $package->no_of_invitations !== null ? 'limited' : 'unlimited') === 'unlimited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_invitations', 'unlimited')" />
                                        <label for="no_of_invitations_unlimited">Unlimited</label>

                                        <input type="radio" name="limit_type_no_of_invitations" id="no_of_invitations_limited" value="limited" {{ (old('limit_type_no_of_invitations', $package->no_of_invitations !== null ? 'limited' : 'unlimited') === 'limited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_invitations', 'limited')" />
                        ...
                        <div class="menu-permission-card">
                            <div style="display: flex; align-items: center; gap: 12px; min-width: 260px; flex-shrink: 0;">
                                <label class="theme-switch">
                                    <input type="checkbox" id="fleet_management_menu" name="fleet_management_menu" value="1" {{ old('fleet_management_menu', $package->fleet_management_menu) ? 'checked' : '' }} />
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="menu-permission-card">
                            <div style="display: flex; align-items: center; gap: 12px; min-width: 260px; flex-shrink: 0;">
                                <label class="theme-switch">
                                    <input type="checkbox" id="extras_menu" name="extras_menu" value="1" {{ old('extras_menu', $package->extras_menu) ? 'checked' : '' }} />
                                    <span class="slider round"></span>
                                </label>
                            ...
                            <div id="extras_limit_container" class="limit-input-wrapper" style="flex-direction: column; gap: 12px; align-items: flex-end;">
                                ...
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div class="segmented-control">
                                        <input type="radio" name="limit_type_no_of_extras" id="no_of_extras_unlimited" value="unlimited" {{ (old('limit_type_no_of_extras', $package->no_of_extras !== null ? 'limited' : 'unlimited') === 'unlimited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_extras', 'unlimited')" />
                                        <label for="no_of_extras_unlimited">Unlimited</label>

                                        <input type="radio" name="limit_type_no_of_extras" id="no_of_extras_limited" value="limited" {{ (old('limit_type_no_of_extras', $package->no_of_extras !== null ? 'limited' : 'unlimited') === 'limited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_extras', 'limited')" />
                                ...
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div class="segmented-control">
                                        <input type="radio" name="limit_type_no_of_insurances" id="no_of_insurances_unlimited" value="unlimited" {{ (old('limit_type_no_of_insurances', $package->no_of_insurances !== null ? 'limited' : 'unlimited') === 'unlimited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_insurances', 'unlimited')" />
                                        <label for="no_of_insurances_unlimited">Unlimited</label>

                                        <input type="radio" name="limit_type_no_of_insurances" id="no_of_insurances_limited" value="limited" {{ (old('limit_type_no_of_insurances', $package->no_of_insurances !== null ? 'limited' : 'unlimited') === 'limited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_insurances', 'limited')" />
                                ...
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div class="segmented-control">
                                        <input type="radio" name="limit_type_no_of_features" id="no_of_features_unlimited" value="unlimited" {{ (old('limit_type_no_of_features', $package->no_of_features !== null ? 'limited' : 'unlimited') === 'unlimited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_features', 'unlimited')" />
                                        <label for="no_of_features_unlimited">Unlimited</label>

                                        <input type="radio" name="limit_type_no_of_features" id="no_of_features_limited" value="limited" {{ (old('limit_type_no_of_features', $package->no_of_features !== null ? 'limited' : 'unlimited') === 'limited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_features', 'limited')" />
                                ...
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div class="segmented-control">
                                        <input type="radio" name="limit_type_no_of_rules" id="no_of_rules_unlimited" value="unlimited" {{ (old('limit_type_no_of_rules', $package->no_of_rules !== null ? 'limited' : 'unlimited') === 'unlimited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_rules', 'unlimited')" />
                                        <label for="no_of_rules_unlimited">Unlimited</label>

                                        <input type="radio" name="limit_type_no_of_rules" id="no_of_rules_limited" value="limited" {{ (old('limit_type_no_of_rules', $package->no_of_rules !== null ? 'limited' : 'unlimited') === 'limited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_rules', 'limited')" />
                        ...
                        <div class="menu-permission-card">
                            <div style="display: flex; align-items: center; gap: 12px; min-width: 260px; flex-shrink: 0;">
                                <label class="theme-switch">
                                    <input type="checkbox" id="coupons_menu" name="coupons_menu" value="1" {{ old('coupons_menu', $package->coupons_menu) ? 'checked' : '' }} />
                                    <span class="slider round"></span>
                                </label>
                            ...
                            <div id="coupons_limit_container" class="limit-input-wrapper">
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div class="segmented-control">
                                        <input type="radio" name="limit_type_no_of_coupons" id="no_of_coupons_unlimited" value="unlimited" {{ (old('limit_type_no_of_coupons', $package->no_of_coupons !== null ? 'limited' : 'unlimited') === 'unlimited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_coupons', 'unlimited')" />
                                        <label for="no_of_coupons_unlimited">Unlimited</label>

                                        <input type="radio" name="limit_type_no_of_coupons" id="no_of_coupons_limited" value="limited" {{ (old('limit_type_no_of_coupons', $package->no_of_coupons !== null ? 'limited' : 'unlimited') === 'limited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_coupons', 'limited')" />
                        ...
                        <div class="menu-permission-card">
                            <div style="display: flex; align-items: center; gap: 12px; min-width: 260px; flex-shrink: 0;">
                                <label class="theme-switch">
                                    <input type="checkbox" id="support_ticket_menu" name="support_ticket_menu" value="1" {{ old('support_ticket_menu', $package->support_ticket_menu) ? 'checked' : '' }} />
                                    <span class="slider round"></span>
                                </label>
                            ...
                            <div id="support_tickets_limit_container" class="limit-input-wrapper">
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div class="segmented-control">
                                        <input type="radio" name="limit_type_no_of_support_tickets" id="no_of_support_tickets_unlimited" value="unlimited" {{ (old('limit_type_no_of_support_tickets', $package->no_of_support_tickets !== null ? 'limited' : 'unlimited') === 'unlimited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_support_tickets', 'unlimited')" />
                                        <label for="no_of_support_tickets_unlimited">Unlimited</label>

                                        <input type="radio" name="limit_type_no_of_support_tickets" id="no_of_support_tickets_limited" value="limited" {{ (old('limit_type_no_of_support_tickets', $package->no_of_support_tickets !== null ? 'limited' : 'unlimited') === 'limited') ? 'checked' : '' }} onchange="toggleLimitInputType('no_of_support_tickets', 'limited')" />
                        ...
                        <div class="menu-permission-card">
                            <div style="display: flex; align-items: center; gap: 12px; min-width: 260px; flex-shrink: 0;">
                                <label class="theme-switch">
                                    <input type="checkbox" id="settings_menu" name="settings_menu" value="1" {{ old('settings_menu', $package->settings_menu) ? 'checked' : '' }} />
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="menu-permission-card">
                            <div style="display: flex; align-items: center; gap: 12px; min-width: 260px; flex-shrink: 0;">
                                <label class="theme-switch">
                                    <input type="checkbox" id="reviews_menu" name="reviews_menu" value="1" {{ old('reviews_menu', $package->reviews_menu ?? true) ? 'checked' : '' }} />
                                    <span class="slider round"></span>
                                </label>
                            ...
                            <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
                                <div class="segmented-control">
                                    <input type="radio" id="reviews_unlimited" name="reviews_limit_type" value="unlimited" {{ old('reviews_limit_type', ($package->no_of_reviews === null || $package->no_of_reviews === '' || $package->no_of_reviews === 'Unlimited') ? 'unlimited' : 'limited') === 'unlimited' ? 'checked' : '' }} onchange="toggleLimitInput('no_of_reviews', this.value)" />
                                    <label for="reviews_unlimited">Unlimited</label>

                                    <input type="radio" id="reviews_limited" name="reviews_limit_type" value="limited" {{ old('reviews_limit_type', ($package->no_of_reviews !== null && $package->no_of_reviews !== '' && $package->no_of_reviews !== 'Unlimited') ? 'limited' : '') === 'limited' ? 'checked' : '' }} onchange="toggleLimitInput('no_of_reviews', this.value)" />
                                    <label for="reviews_limited">Limited</label>
                                </div>

                                <div id="no_of_reviews_wrapper" style="display: {{ old('reviews_limit_type', ($package->no_of_reviews !== null && $package->no_of_reviews !== '' && $package->no_of_reviews !== 'Unlimited') ? 'block' : 'none') }};">
                                    <input type="number" class="limit-input-field @error('no_of_reviews') is-invalid @enderror" id="no_of_reviews" name="no_of_reviews" value="{{ old('no_of_reviews', $package->no_of_reviews) }}" placeholder="e.g. 50" min="1" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="menu-permission-card">
                            <div style="display: flex; align-items: center; gap: 12px; min-width: 260px; flex-shrink: 0;">
                                <label class="theme-switch">
                                    <input type="checkbox" id="drivers_menu" name="drivers_menu" value="1" {{ old('drivers_menu', $package->drivers_menu ?? true) ? 'checked' : '' }} />
                                    <span class="slider round"></span>
                                </label>
                            ...
                            <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
                                <div class="segmented-control">
                                    <input type="radio" id="drivers_unlimited" name="drivers_limit_type" value="unlimited" {{ old('drivers_limit_type', ($package->no_of_drivers === null || $package->no_of_drivers === '' || $package->no_of_drivers === 'Unlimited') ? 'unlimited' : 'limited') === 'unlimited' ? 'checked' : '' }} onchange="toggleLimitInput('no_of_drivers', this.value)" />
                                    <label for="drivers_unlimited">Unlimited</label>

                                    <input type="radio" id="drivers_limited" name="drivers_limit_type" value="limited" {{ old('drivers_limit_type', ($package->no_of_drivers !== null && $package->no_of_drivers !== '' && $package->no_of_drivers !== 'Unlimited') ? 'limited' : '') === 'limited' ? 'checked' : '' }} onchange="toggleLimitInput('no_of_drivers', this.value)" />
                                    <label for="drivers_limited">Limited</label>
                                </div>

                                <div id="no_of_drivers_wrapper" style="display: {{ old('drivers_limit_type', ($package->no_of_drivers !== null && $package->no_of_drivers !== '' && $package->no_of_drivers !== 'Unlimited') ? 'block' : 'none') }};">
                                    <input type="number" class="limit-input-field @error('no_of_drivers') is-invalid @enderror" id="no_of_drivers" name="no_of_drivers" value="{{ old('no_of_drivers', $package->no_of_drivers) }}" placeholder="e.g. 10" min="1" />
                                </div>
                            </div>
                        </div>
