                ...
                <div class="row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    ...
                    <div>
                        ...
                        <input type="number" class="form-control form-input-custom @error('no_of_users') is-invalid @enderror" id="no_of_users" name="no_of_users"
                            value="{{ old('no_of_users', $package->no_of_users) }}" min="0" placeholder="0" style="border: 1px solid #d7e0e8; border-radius: var(--radius); padding: 12px; font-size: 0.95rem; width: 100%;" />
                        @error('no_of_users')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" class="form-control form-input-custom @error('no_of_vehicles') is-invalid @enderror" id="no_of_vehicles" name="no_of_vehicles"
                            value="{{ old('no_of_vehicles', $package->no_of_vehicles) }}" min="0" placeholder="0" style="border: 1px solid #d7e0e8; border-radius: var(--radius); padding: 12px; font-size: 0.95rem; width: 100%;" />
                ...
                <div class="row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    ...
                    <div>
                        ...
                        <input type="number" class="form-control form-input-custom @error('no_of_groups') is-invalid @enderror" id="no_of_groups" name="no_of_groups"
                            value="{{ old('no_of_groups', $package->no_of_groups) }}" min="0" placeholder="0" style="border: 1px solid #d7e0e8; border-radius: var(--radius); padding: 12px; font-size: 0.95rem; width: 100%;" />
                        @error('no_of_groups')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" class="form-control form-input-custom @error('no_of_coupons') is-invalid @enderror" id="no_of_coupons" name="no_of_coupons"
                            value="{{ old('no_of_coupons', $package->no_of_coupons ?? 0) }}" min="0" placeholder="0" style="border: 1px solid #d7e0e8; border-radius: var(--radius); padding: 12px; font-size: 0.95rem; width: 100%;" />
                        @error('no_of_coupons')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
