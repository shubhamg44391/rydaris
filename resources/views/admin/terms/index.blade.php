        ...
        <form action="{{ route('admin.terms.store') }}" method="POST" id="tc-form">
            ...
            <div style="margin-bottom: 22px;">
                ...
                <input
                    ...
                    style="width: 100%; padding: 12px 16px; background: rgba(255,255,255,0.04); border: 1px solid {{ $errors->has('meta_title') ? '#fb7185' : 'rgba(255,255,255,0.1)' }}; border-radius: 9px; color: #f1f5f9; font-size: 0.95rem; outline: none; box-sizing: border-box; transition: border-color 0.2s;"
                    onfocus="this.style.borderColor='#52ead2'" onblur="this.style.borderColor='{{ $errors->has('meta_title') ? '#fb7185' : 'rgba(255,255,255,0.1)' }}'"
                />
                @error('meta_title')
                    <p style="color: #fb7185; font-size: 0.82rem; margin: 6px 0 0 2px;">{{ $message }}</p>
                @enderror
            ...
            <div style="margin-bottom: 22px;">
                ...
                <textarea
                    ...
                    style="width: 100%; padding: 12px 16px; background: rgba(255,255,255,0.04); border: 1px solid {{ $errors->has('meta_description') ? '#fb7185' : 'rgba(255,255,255,0.1)' }}; border-radius: 9px; color: #f1f5f9; font-size: 0.95rem; outline: none; box-sizing: border-box; resize: vertical; transition: border-color 0.2s;"
                    onfocus="this.style.borderColor='#52ead2'" onblur="this.style.borderColor='{{ $errors->has('meta_description') ? '#fb7185' : 'rgba(255,255,255,0.1)' }}'"
