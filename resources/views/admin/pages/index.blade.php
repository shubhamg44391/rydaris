...
@section('main-content')
    <div class="admin-panel">
        <div class="panel-head" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
            ...
            @endphp
            @if(count($missingPredefined) > 0 && auth()->user()->hasAdminPermission('pages', 'add'))
                <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-actions" style="display: flex; gap: 8px;">
                                    ...
                                    @if(auth()->user()->hasAdminPermission('pages', 'edit'))
                                    ...
                                    @endif
                                    @if(auth()->user()->hasAdminPermission('pages', 'delete'))
