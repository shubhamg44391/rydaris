...
@section('main-content')
    @php
        $isDefaultPage = in_array($page->slug, [
            'help-center', 'roi-guide', 'fleet-playbook', 'support-desk', 'sitemap', 'security', 'privacy-policy', 'terms-of-service'
        ], true);
    @endphp
    ...
    <div style="margin-bottom: 20px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 10px;">
        <div>
            <h4 style="margin: 0; color: #fff; font-weight: 700; font-size: 1.4rem;">Edit Custom Page</h4>
    ...
    <form id="editPageForm" action="{{ route('admin.pages.update', $page->id) }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div style="display: flex; flex-direction: column; gap: 24px;">
                <div class="admin-panel" style="padding: 24px; border: 1px solid var(--line); border-radius: var(--radius); background: var(--panel);">
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="text" name="title" id="title" class="form-control" required value="{{ old('title', $page->title) }}" placeholder="Enter page title" style="background: rgba(255,255,255,0.01) !important; border: 1px solid var(--line); border-radius: 8px; padding: 12px; font-size: 0.95rem; color: #fff; width: 100%; cursor: not-allowed; opacity: 0.8;" readonly>
            ...
            <div style="display: flex; flex-direction: column; gap: 24px;">
                ...
                <div class="admin-panel" style="padding: 20px; border: 1px solid var(--line); border-radius: var(--radius); background: var(--panel);">
                    ...
                    <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 20px;">
                        ...
                        <span style="color: var(--muted); font-size: 0.85rem; font-weight: 600;">Status: Published</span>
                    </div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 10px;">
                        ...
                        <a href="{{ route('admin.pages.index') }}" class="admin-action" style="background: rgba(255, 255, 255, 0.03); border: 1px solid var(--line); color: var(--text); text-align: center; width: 100%; padding: 10px; border-radius: 8px; font-size: 0.85rem; cursor: pointer; transition: all 0.2s; text-decoration: none;">
                            Cancel
                        </a>
                    </div>
                </div>
                ...
                <div class="admin-panel" style="padding: 20px; border: 1px solid var(--line); border-radius: var(--radius); background: var(--panel);">
                    ...
                    <div style="margin-bottom: 18px;">
                        ...
                        <input type="text" name="meta_title" id="meta_title" class="form-control" value="{{ old('meta_title', $page->meta_title) }}" placeholder="SEO title (recommended length: 50-60 chars)" style="background: rgba(255,255,255,0.03); border: 1px solid var(--line); border-radius: 8px; padding: 10px; font-size: 0.9rem; color: #fff; width: 100%;">
